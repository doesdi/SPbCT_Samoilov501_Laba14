...
#pragma region Windows Form Designer generated code
			...
			void InitializeComponent(void)
			{
				...
				this->label13->Text = L"Миниимальное значение на промежутке:";
				// 
				// label11
				// 
				...
				this->label19->Text = L"Миниимальное значение на промежутке:";
				// 
				// label20
				// 
				...
				this->label24->Text = L"Задайте значения: ";
				// 
				// textBox8
				// 
				...
				this->label35->Text = L"Задайте интервал: ";
				// 
				// label6
				// 
...
#pragma endregion
		private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			try {
				...
				MessageBox::Show("Íåâîçìîæíî äëÿ çàäàííûõ çíà÷åíèé");
			}
